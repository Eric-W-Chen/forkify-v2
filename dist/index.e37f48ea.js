...
const init = function() {
    ...
    (0, _recipeViewDefault.default).addHandlerToggleBookmark(controlToggleBookmark);
...
},{"core-js/modules/web.immediate.js":"49tUX","./model":"Y4A21","./views/RecipeView":"aFEMw","./views/SearchView":"c7Rpf","./views/ResultsView":"8JjiB","./views/PaginationView":"9Uw3J","./views/BookmarksView":"5GCfw","./views/AddRecipeView":"buCK7","regenerator-runtime":"dXNgZ","./config":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
"use strict";
...
const uploadRecipe = async function(newRecipe) {
    try {
        ...
        const data = await (0, _helpers.AJAX)(`${(0, _config.API_URL)}?search=${recipe.title}&key=${(0, _config.API_KEY)}`, recipe);
        state.recipe = createRecipeObject(data);
...
const API_KEY = "786378a9-17fb-4888-b735-553b6c89e880";
...
class RecipeView extends (0, _viewDefault.default) {
    ...
    _generateMarkupIngredients(el) {
        return `<li class="recipe__ingredient">
            ...
            <div class="recipe__quantity">${el.quantity ? (0, _fractyDefault.default)(el.quantity).toString() : ""}</div>
    ...
    update(data) {
        ...
        newElements.forEach((newEl, i)=>{
            ...
            if (!currEl.isEqualNode(newEl) && currEl.firstChild?.nodeValue.trim() !== "") {
                ...
                if (!currEl.isEqualNode(newEl)) Array.from(newEl.attributes).forEach((attr)=>{
...
},{"./View":"5cUXS","./PreviewView":"lwi5y","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lwi5y":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./View":"5cUXS","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5GCfw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./View":"5cUXS","./PreviewView":"lwi5y","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"buCK7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
